...
const estilosPorVariante: Record<VarianteBoton, string> = {
  ...
  secundario:
    'bg-[var(--color-surface)] text-[var(--color-brand-primary)] border border-[var(--color-brand-primary)] hover:bg-[var(--color-brand-soft)] active:bg-[var(--color-brand-soft)] disabled:opacity-50',
  terciario:
