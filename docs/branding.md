...
| Token | Hex | Uso |
| --- | --- | --- |
| `brand-primary` | `#175E36` | CTA principal, selección e identidad. |
| `canvas` | `#FAF9F6` | Fondo general marfil. |
...
| Token | Hex | Uso |
| --- | --- | --- |
| `surface` | `#FFFFFF` | Tarjetas, menús y campos. |
| `ink` | `#18392B` | Texto principal. |
| `text-muted` | `#66675E` | Texto secundario. |
| `border` | `#E5E1D7` | Separadores y bordes decorativos. |
| `control-border` | `#82867C` | Límites de campos cuando el borde identifica el control. |
...
:root {
  ...
  --color-ink: #18392b;
  --color-text-muted: #66675e;
  --color-border: #e5e1d7;
  --color-control-border: #82867c;
  ...
  --space-8: 32px;
  --space-12: 48px;
  --shadow-card: 0 1px 3px rgb(24 57 43 / 0.06);
  --duration-fast: 160ms;
}
