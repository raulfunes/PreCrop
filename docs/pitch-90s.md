...
**[0:15] Qué es PreCrop**
PreCrop es el semáforo del lote. Mira el cultivo con satélite, cruza el clima y suma fotos de puntos del lote, y devuelve un score de cero a cien. Verde, la coop suelta el próximo desembolso. Rojo, lo frena. Semanal, sin ir al campo.

**[0:35] La prueba, con un lote real**
Esto es un lote de soja en Río Segundo, Córdoba, campaña pasada. Dos de febrero: NDVI alto, llovió 47 milímetros, score 74, verde. Primer desembolso aprobado. Cinco días después: seca de dos semanas, cero lluvia, malezas creciendo. Score 48, rojo. El segundo desembolso se rechaza solo. Nadie tuvo que viajar.

**[0:55] Por qué se puede confiar**
Cada score sale de un informe con los datos crudos: la escena de satélite, la lluvia, las fotos. Ese informe se hashea y se firma en Solana. La coop abre el explorador y verifica que nadie tocó el número después. No usamos la cadena para prestar plata. La usamos como escribano de la evidencia.

**[1:10] El negocio**
No somos un banco. Vendemos la verdad del lote a quien ya presta: cooperativas, acopios, fintech. Por lote o por campaña. Nuestro primer cliente es la coop que hoy decide con Excel.

**[1:20] Cierre**
Las malezas hoy son estimadas, y lo decimos. Lo demás está medido y firmado. PreCrop: que el campo hable solo, y que el anticipo deje de ser a ojo.
