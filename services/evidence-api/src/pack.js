...
export function loadPack() {
  ...
  const history = readJson("lote-history.json");
  const official = readJson("rindes-oficiales.json");
  const versions = new Set([presets.pack_version, scenarios.pack_version, points.pack_version, economics.pack_version, history.pack_version, official.pack_version]);
